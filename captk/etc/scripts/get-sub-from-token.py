...
# This script takes the sub claim from a token. This should only be called on tokens that have already been validated.
...
def get_sub_from_token():
    ...
    try:
        ...
        #    result = claims['sub']
            ...
            print("Claims don't subject. Double-check the token.")
            raise ValueError("claims don't contain subject. Verify the token.")
        return result
    except:
...
this_token_identifier = get_sub_from_token()
